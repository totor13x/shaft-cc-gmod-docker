...
local newLines, allowedOrign, NotifyBase, NotifyAnimated, NotifyDispatcherBase
do
  local _obj_0 = Notify
  newLines, allowedOrign, NotifyBase, NotifyAnimated, NotifyDispatcherBase = _obj_0.newLines, _obj_0.allowedOrign, _obj_0.NotifyBase, _obj_0.NotifyAnimated, _obj_0.NotifyDispatcherBase
end
...
do
  ...
  _class_0 = setmetatable({
    __init = function(self, ...)
      self.m_side = Notify_SIDE_LEFT
      self.m_defSide = Notify_SIDE_LEFT
      self.m_allowedSides = {
        Notify_SIDE_LEFT,
        Notify_SIDE_RIGHT
      }
