...
function TTS:UpdateNotice( i, Panel, Count )
	local x = Panel.fx
	local y = Panel.fy
...
hook.Add("Think", "HUD.NotificationsThink", TTS.UpdateNotes)

-- hook.Add("TTS::InitNetStream", "TTS::InitNotifications", function()
timer.Simple(1, function()
  -- print('init netstream hook')
  netstream.Hook("TTS::Notification", function(data)
    -- PrintTable(data)
    TTS:AddNote( data.text, data.type, data.length )
  end)
end)
-- end)
