...
function PANEL:Paint( w, h )
    ...
    surface.DrawText( "[RIGHT CLICK] Select object" )
    surface.SetTextPos( 65, 160 )
    surface.DrawText( "(click on empty space to create new object)" )
    surface.SetTextPos( 65, 180 )
    surface.DrawText( "[LEFT CLICK] Create point" )
    surface.SetTextPos( 65, 200 )
    surface.DrawText( "["..menu_key_name.."] Display MapPatcher menu" )
    surface.SetTextPos( 65, 220 )
    surface.DrawText( "[SCROLL] Change point distance" )
    surface.SetTextPos( 65, 240 )
    surface.DrawText( "["..scores_key_name.."] Exit the editor" )
end
